...
full-size sends slightly — measured 1228 → 1229-1244 on the wire. Neither mechanism can cause
fragmentation, but neither is quite as free as "only pads small packets" implies.
