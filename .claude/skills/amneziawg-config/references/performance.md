...
holds and fragmentation stays impossible in practice (verified: 99.995% of captured datagrams at
exactly the cap) — but not absolutely: the handshake-burst outliers above were observed *over* the
